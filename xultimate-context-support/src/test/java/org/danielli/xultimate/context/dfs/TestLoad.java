...
public class TestLoad {
	...
	public static class Downloader {
		...
		public Downloader(TrackerClient tracker) throws Exception {
	...
	public static class DownloadThread extends Thread {
		...
		public DownloadThread(int index, TrackerClient tracker) {
			this.thread_index = index;
			this.tracker = tracker;
		}
		...
		public void run() {
			try {
				String file_id;
				Downloader downloader = new Downloader(tracker);
	...
	public void test() {
		...
		try {
			...
			for (int i = 0; i < 20; i++) {
				(new DownloadThread(i, storageClientTemplate.getTrackerClient())).start();
			}
		} catch (Exception ex) {
			ex.printStackTrace();
		}
